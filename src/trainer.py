...
def trainer(model, trainloader, evalloader, n_users, n_items, n_genders, n_authors, epochs = 40, device = 'cuda', early_stopping = True, n_factors = 16, lr = 0.0005, weight_decay = 1e-5):
    ...
    model = model(n_users, n_items,n_genders,n_authors, device, n_factors=n_factors)
